...
if("TRUE" STREQUAL "TRUE")
  set(mybot_description_SOURCE_PREFIX /home/parallels/catkin_ws/src/mybot_description)
  set(mybot_description_DEVEL_PREFIX /home/parallels/catkin_ws/devel)
  ...
  set(mybot_description_INSTALL_PREFIX /home/parallels/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'mybot_description' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'parallels <parallels@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'mybot_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/parallels/catkin_ws/src/mybot_description/${idir}'.  Ask the maintainer 'parallels <parallels@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/parallels/catkin_ws/devel/lib;/opt/ros/indigo/lib)
